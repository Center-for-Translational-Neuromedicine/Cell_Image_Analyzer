"""
Base Tab class for workspace tabs.
Provides a consistent interface for all tabs within workspaces.
"""
...
class BaseTab(QWidget):
    ...
    # Signal emitted when tab data changes (for inter-tab communication)
